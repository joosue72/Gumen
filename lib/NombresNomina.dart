...
import 'MenuNominas.dart';
 ...
 class NombresNomina extends StatefulWidget {
  NombresNomina({Key key}) : super(key: key);

  @override
  _NombresNominaState createState() => _NombresNominaState();
}
...
class _NombresNominaState extends State<NombresNomina> {
  @override
  ...
  return PreferredSize(
    ...
    MaterialPageRoute(builder: (context) => MenuNominas()),
        ...
        Text('Nombres Empleados', style: TextStyle(fontSize: 22, fontWeight: FontWeight.w500),),
...
showAlertDialog(BuildContext context, DocumentSnapshot doc) {
  ...
  AlertDialog alert = AlertDialog(
    title: Text("Alerta!"),
    content: Text("¿Estás seguro de que quieres eliminar este Empleado?"),
    actions: [
      cancelButton,
      continueButton,
    ],
 ...
 void deleteData(DocumentSnapshot doc) async {
    await db.collection('NombresNomina').document(doc.documentID).delete();
    setState(() => id = null);
  }
}